define([
	...
	var initGame = function(callback) {
		...
		rw.loadSprites({
			...
			hero: {
				src: '../../Rosewood/examples/evileye/sprites/hero.png',
				d1: [30, 30, 0, 0],
				d2: [30, 30, 0, 30],
				u1: [30, 30, 30, 0],
				u2: [30, 30, 30, 30],
			...
			eye_d1: ['../../Rosewood/examples/evileye/sprites/eye_d1.gif', 30, 30],
			eye_l1: ['../../Rosewood/examples/evileye/sprites/eye_l1.gif', 30, 30],
			eye_r1: ['../../Rosewood/examples/evileye/sprites/eye_r1.gif', 30, 30],
			eye_u1: ['../../Rosewood/examples/evileye/sprites/eye_u1.gif', 30, 30],
			eye_d2: ['../../Rosewood/examples/evileye/sprites/eye_d2.gif', 30, 30],
			eye_l2: ['../../Rosewood/examples/evileye/sprites/eye_l2.gif', 30, 30],
			eye_r2: ['../../Rosewood/examples/evileye/sprites/eye_r2.gif', 30, 30],
			eye_u2: ['../../Rosewood/examples/evileye/sprites/eye_u2.gif', 30, 30],
			badluck: ['../../Rosewood/examples/evileye/sprites/badluck.gif', 30, 30],
			blindeye: ['../../Rosewood/examples/evileye/sprites/blindeye.gif', 30, 30],
			fatima: ['../../Rosewood/examples/evileye/sprites/fatima.gif', 30, 30],
			question: ['../../Rosewood/examples/evileye/sprites/question.gif', 30, 30],
